...
class CardDealer 
    ...
    def createSuppliesPackages() 
        ...
        @suppliesPackages.add(SuppliesPackage.new(1,50,3)) #Lo hemos añadido
    end
    ...
    def createWeapons() 
       ...
       @weapons.add(Weapon.new("Cañón mas mejorado",WeaponType::PLASMA,3))  #Lo hemos añadido
    ...
    def createShieldBoosters() 
       ...
       @shieldBoosters.add(ShieldBooster.new("Escudo normal",5.0,2)) #Lo hemos añadido
    end
    ...
    def createHangars() 
        ...
        @hangars.add(Hangar.new(1))
        @hangars.add(Hangar.new(1))  #Lo hemos añadido
    end
    
    def createEnemies() 
        regularLoot0=Loot.new(1,2,4,1,1)
        ...
        @enemies.add(EnemyStarShip.new("Enemigo normal 2",100,70,regularLoot0,mediumSpecificDamage0));
    end
end # class
