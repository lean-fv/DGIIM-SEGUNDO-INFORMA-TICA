...
class CardDealer {
    ...
    private void createSuppliesPackages() {
        ...
        suppliesPackages.add(new SuppliesPackage(1,50,3)); //Lo hemos añadido
    }
    private void createWeapons() {
       ...
       weapons.add(new Weapon("Cañón mas mejorado",WeaponType.PLASMA,3)); //Lo hemos añadido
    ...
    private void createShieldBoosters() {
       ...
       shieldBoosters.add(new ShieldBooster("Escudo normal",5.0f,2)); //Lo hemos añadido
    }
    private void createHangars() {
        ...
        hangars.add(new Hangar(1));
        hangars.add(new Hangar(1)); //Lo hemos añadido
    }
    private void createEnemies() {
        ...
        enemies.add(new EnemyStarShip("Enemigo normal 2",100,70,regularLoot0,mediumSpecificDamage0));//Lo hemos añadido
    }
}
