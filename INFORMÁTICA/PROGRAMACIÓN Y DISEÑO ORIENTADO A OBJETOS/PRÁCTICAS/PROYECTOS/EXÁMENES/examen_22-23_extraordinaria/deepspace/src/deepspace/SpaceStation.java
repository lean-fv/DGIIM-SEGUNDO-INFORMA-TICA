...
public class SpaceStation implements SpaceFighter{
    ...
    */
    ...
    public void Cataclismo(){
        
        discardWeapon(weapons.size()-1);
        discardWeapon(0);
    }
    
    
    public void changeCataclismo(){
        
        cataclismo=false;
    }
    
    public boolean getCataclismo(){
        return cataclismo;
    }
    ...
    public String toString(){
        ...
        if (hangar !=null) output +=hangar.toString();
        
        output+= "\nDamage: \n";
        
        if (pendingDamage !=null) output+= pendingDamage.toString();
