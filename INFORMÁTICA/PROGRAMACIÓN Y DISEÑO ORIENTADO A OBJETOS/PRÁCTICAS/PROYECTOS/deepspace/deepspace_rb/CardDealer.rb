...
class CardDealer 
    ...
    def createEnemies() 
        ...
        @enemies.add(EnemyStarShip.new("Enemigo transforma 0",1,1,transformLoot0,regularDamage0))
        @enemies.add(EnemyStarShip.new("Enemigo transforma 1",1,1,transformLoot1,regularDamage1))
    end
end # class
