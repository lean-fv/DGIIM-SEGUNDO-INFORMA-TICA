...
//    private int nShields;
    ...
    public ArrayList<WeaponTypeToUI> getUIWeapons(){
        
        ArrayList<WeaponTypeToUI> weapons_ui = new ArrayList<>();
        
        for (int i=0; i<weapons.size();i++) weapons_ui.add(new WeaponTypeToUI(weapons.get(i)));
