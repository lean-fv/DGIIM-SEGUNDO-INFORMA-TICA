...
class CardDealer {
    ...
    private void createEnemies() {
        ...
        enemies.add(new EnemyStarShip("Enemigo transforma 0",1,1,transformLoot0,regularDamage0));  
        enemies.add(new EnemyStarShip("Enemigo transforma 1",1,1,transformLoot1,regularDamage1));           
    }
}