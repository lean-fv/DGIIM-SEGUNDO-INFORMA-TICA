...
public class GameUniverse {
    ...
    */
    ...
    public void Steal(){
        ...
        SpaceStation victim=spaceStations.get(player);
        
        Weapon stolen_weapon= victim.getMountedWeapon(victim.getWeaponsSize()-1);
        
        currentStation.receiveWeapon(stolen_weapon);
        victim.discardWeaponInHangar(victim.getWeaponsSize()-1);
        
        stolen_weapon=victim.getMountedWeapon(0);
        
        currentStation.receiveWeapon(stolen_weapon);
        victim.discardWeaponInHangar(0);
        
    }
    
    public boolean canSteal(){
        
        return currentStation.getSteal();
    }
