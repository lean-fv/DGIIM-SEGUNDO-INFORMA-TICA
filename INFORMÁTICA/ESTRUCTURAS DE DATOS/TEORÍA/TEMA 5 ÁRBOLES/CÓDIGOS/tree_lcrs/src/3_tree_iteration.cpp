...
int main(int argc, char *argv[])
{
  ...
  tree_2.insert_right_sibling(n2, tree_1);

  cout << tree_2;

  cout << "Preorder iteration: " << endl;
  for (auto preorder_it = tree_2.cbegin_preorder();
       preorder_it != tree_2.cend_preorder();
       ++preorder_it){
    cout << *preorder_it << endl;
  }
  cout << endl;

  cout << "Levels iteration: " << endl;
  for (auto preorder_it = tree_2.cbegin_level();
       preorder_it != tree_2.cend_level();
       ++preorder_it){
    cout << *preorder_it << endl;
  }
