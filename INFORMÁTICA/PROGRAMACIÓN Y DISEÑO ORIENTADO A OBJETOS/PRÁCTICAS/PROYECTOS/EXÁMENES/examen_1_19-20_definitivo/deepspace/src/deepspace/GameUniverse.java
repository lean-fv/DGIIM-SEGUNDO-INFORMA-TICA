...
public class GameUniverse {
    ...
    private ArrayList<SpaceFighter> fighters;
    ...
    */
    ...
    public void addFighter(){
        ...
        if (dice.Fighter()) fighter= new SpaceStation("Station",dealer.nextSuppliesPackage());
        else fighter= dealer.nextEnemy();
        
        fighters.add(fighter);
    }
    
    
    public void deleteFighter(int i){
        
        if(0<=i && i<fighters.size()) fighters.remove(i);
    }
    
    
    public ArrayList<SpaceFighterToUI> getUIFighters(){
        
        ArrayList<SpaceFighterToUI> fighters_ui= new ArrayList<>();
        
        for (int i=0; i<fighters.size();i++) fighters_ui.add(new SpaceFighterToUI(fighters.get(i)));
