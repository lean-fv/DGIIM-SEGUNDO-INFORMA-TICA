...
public:
  ...
  /**
   * @brief Levels iterator. Allows to iterate over the tree using breadth first policy
   */
  class level_iterator {
  public:
    level_iterator();
    level_iterator(const node &n);
  ...
  /**
   * @brief Constant levels iterator. Allows to iterate over the tree using breadth first policy
   */
  class const_level_iterator {
  public:
    const_level_iterator();
    const_level_iterator(const node &n);
  ...
  const_level_iterator cbegin_level() const;
  const_level_iterator cend_level() const ;
