...
public class Controller {
    ...
    public void addFire(){game.addFire();}
    
    public void deleteFire(ArrayList<Integer> indexes){
        
        invertArray(indexes);
        
        for(Integer i: indexes )game.removeFire(i);
    }
    
    public ArrayList<Float> getFire(){return game.getFire();}
}
