...
public class GameUniverse {
    ...
    */
    ...
    public void addFire(){
        ...
        if (dice.fire()) fire = new SpaceStation("Station",dealer.nextSuppliesPackage()).fire();
        else fire=dealer.nextEnemy().fire();
    ...
    public void removeFire(int i){
        ...
        if (0<=i && i<fire.size()) fire.remove(i);
    }
    
    public ArrayList<Float> getFire(){return (ArrayList<Float>)fire.clone();}
